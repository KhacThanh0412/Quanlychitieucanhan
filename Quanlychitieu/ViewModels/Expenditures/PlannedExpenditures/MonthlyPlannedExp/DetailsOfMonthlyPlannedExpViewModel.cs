...
public partial class DetailsOfMonthlyPlannedExpViewModel : ObservableObject
{
    ...
    public DetailsOfMonthlyPlannedExpViewModel(IPlannedExpendituresRepository monthlyPlannedExpRepo, IUsersRepository userRepo)
    {
