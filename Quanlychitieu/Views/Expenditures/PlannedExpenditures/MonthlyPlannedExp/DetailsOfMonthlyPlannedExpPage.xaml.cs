...
public partial class DetailsOfMonthlyPlannedExpPage : ContentPage
{
    DetailsOfMonthlyPlannedExpViewModel viewModel;
    public DetailsOfMonthlyPlannedExpPage(DetailsOfMonthlyPlannedExpViewModel vm)
    {
        InitializeComponent();
        viewModel = vm;
        BindingContext = vm;
