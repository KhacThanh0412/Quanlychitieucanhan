...
public partial class ManageMonthlyPlannedExpendituresPage : ContentPage
{
    private ManageMonthlyMonthlyPlannedExpendituresViewModel viewModel;
    public ManageMonthlyPlannedExpendituresPage(ManageMonthlyMonthlyPlannedExpendituresViewModel vm)
    {
        InitializeComponent();
        viewModel = vm;
        BindingContext = vm;
